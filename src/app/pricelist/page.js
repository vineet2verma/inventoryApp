...
export default function PriceListPage() {
  ...
  useEffect(() => {
    setrightread(user.user?.pprice.includes("read"));
    setrightcreate(user.user?.pprice.includes("create"));
    setrightedit(user.user?.pprice.includes("update"));
    setrightdelete(user.user?.pprice.includes("delete"));
  }, [user]);
