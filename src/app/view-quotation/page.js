...
import { House, Trash, View, Trash2 } from 'lucide-react'
...
export default function ViewQuotation () {
  ...
  return (
    <div className='px-4 py-2 bg-gray-100 '>
      ...
      <div className='overflow-x-auto overflow-y-auto sticky top-0 shadow-md rounded-lg max-h-120'>
              ...
              <tr key={index} className=' odd:bg-gray-200 even:bg-white '>
                ...
                <td className='px-2 text-center py-2 text-xs'>
                  ...
                  <button
                    ...
                    className='bg-red-600 hover:bg-blue-700 text-white px-2 py-1 rounded-md text-sm mx-2'
                  >
